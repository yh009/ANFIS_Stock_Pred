setwd("/Users/mac/Desktop/stockData/raw fundamentals/")
...
clean <- function(fName,dataName,corName){
  # load data
  rawdata = read.csv(fName)  #"CAT_quarterly_financial_data.csv"
  ...
  myCor = round(cor(x=myData[,2:22], y=myData[,23]),4)
  
  # output dataframe to csv
  write.csv(myData, file = dataName)
  write.csv(myCor, file = corName)
}

clean("XOM_quarterly_financial_data.csv", "XOM.csv", "XOM_cor.csv")
