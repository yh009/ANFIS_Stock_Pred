## Compute stock relative return over DJIA as target variable
...
# load data
rawdata = read.csv("HD_quarterly_financial_data.csv")
...
myDataFinal = myData[myData$fakeDate>=as.Date("1995-01-01") & myData$fakeDate<=as.Date("2017-12-31"),]

myDataFinal = myDataFinal[, -which(names(myData) %in% c("fakeDate"))]

# output dataframe to csv
write.csv(myData, file = "../DJ30/CAT.csv")
